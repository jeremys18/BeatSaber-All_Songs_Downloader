...
namespace BeatSaber_All_Songs_Downloader
{
    internal static class Consts
    {
        ...
        internal const string PageBaseUrl = "https://beatsaver.com/api/maps/";
        static internal readonly List<string> FilterOptions = new List<string> { "plays", "rating", "downloads", "latest" };
        ...
        internal const string UserAgentHeaderValue = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36";
